...
namespace DddInPractice.Data.Migrations
{
    ...
    [Migration("20220301144000_CreateSnackAndSlotEntities")]
    partial class CreateSnackAndSlotEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DddInPractice.Domain.Snack", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DddInPractice.Domain.SnackMachine", b =>
                {
                    ...
                    b.OwnsMany("DddInPractice.Domain.Slot", "Slots", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
                            ...
                            b1.OwnsOne("DddInPractice.Domain.SnackPile", "SnackPile", b2 =>
                                {
                                    ...
                                    b2.HasOne("DddInPractice.Domain.Snack", "Snack")
                                        .WithMany()
