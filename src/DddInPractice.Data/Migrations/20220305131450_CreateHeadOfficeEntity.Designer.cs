...
namespace DddInPractice.Data.Migrations
{
    ...
    [Migration("20220305131450_CreateHeadOfficeEntity")]
    partial class CreateHeadOfficeEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DddInPractice.Domain.BoundedContext.Management.HeadOfficeAggregate.HeadOffice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("HeadOffice", (string)null);
            ...
            modelBuilder.Entity("DddInPractice.Domain.BoundedContext.Management.HeadOfficeAggregate.HeadOffice", b =>
                {
                    b.OwnsOne("DddInPractice.Domain.SharedKernel.Money", "Cash", b1 =>
                        {
                            b1.Property<long>("HeadOfficeId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("HeadOfficeId");

                            b1.ToTable("HeadOffice");
